...
module CaliforniaStatePortalTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("CALIFORNIASTATEPORTAL_TEST_LIVE")
    override = getenv("CALIFORNIASTATEPORTAL_TEST_OVERRIDE")
    ...
    explain = getenv("CALIFORNIASTATEPORTAL_TEST_EXPLAIN")
    m["CALIFORNIASTATEPORTAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CaliforniaStatePortalTestRunner
Helpers = CaliforniaStatePortalHelpers
Vs = VoxgigStruct
