...
#      offline in seeded test mode (CaliforniaStatePortalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CaliforniaStatePortal_sdk.rb")
  SDK_CLASS = "CaliforniaStatePortalSDK"
  ...
  SDK_BASE = "CaliforniaStatePortal_sdk"
