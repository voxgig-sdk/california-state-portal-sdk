# CaliforniaStatePortal Ruby SDK Reference

Complete API reference for the CaliforniaStatePortal Ruby SDK.
...
#### `CaliforniaStatePortalSDK.test(testopts = nil, sdkopts = nil)`
