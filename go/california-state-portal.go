...
// instead of `sdk.NewCaliforniaStatePortalSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CaliforniaStatePortalSDK  { return NewCaliforniaStatePortalSDK(nil) }
func Test() *CaliforniaStatePortalSDK { return TestSDK(nil, nil) }
