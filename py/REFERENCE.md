# CaliforniaStatePortal Python SDK Reference

Complete API reference for the CaliforniaStatePortal Python SDK.
...
#### `CaliforniaStatePortalSDK.test(testopts=None, sdkopts=None)`
