...
The Python SDK for the CaliforniaStatePortal API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/california-state-portal-sdk/releases)) or
