# CaliforniaStatePortal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CaliforniaStatePortalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CaliforniaStatePortalSDK(...) and CaliforniaStatePortalSDK.test(...) become
#      CaliforniaStatePortalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "californiastateportal_sdk"
_SDK_CLASS = "CaliforniaStatePortalSDK"
