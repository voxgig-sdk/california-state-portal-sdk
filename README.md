...
CA.gov serves as the official website for the State of California, providing access to various government services and resources for residents and visitors.

Learn more about California State Portal API at [ca.gov](https://ca.gov).
...
// services is an array of bare Service records populated with mock data
...
| Go CLI | `github.com/voxgig-sdk/california-state-portal-sdk/go-cli` | `go install github.com/voxgig-sdk/california-state-portal-sdk/go-cli/cmd/california-state-portal@latest` |
| Go MCP server | `github.com/voxgig-sdk/california-state-portal-sdk/go-mcp` | `go get github.com/voxgig-sdk/california-state-portal-sdk/go-mcp@latest` |
