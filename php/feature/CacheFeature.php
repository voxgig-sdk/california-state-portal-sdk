...
// CaliforniaStatePortal SDK cache feature
...
class CaliforniaStatePortalCacheFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _through(CaliforniaStatePortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
