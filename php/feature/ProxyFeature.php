...
// CaliforniaStatePortal SDK proxy feature
...
class CaliforniaStatePortalProxyFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    public function init(CaliforniaStatePortalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CaliforniaStatePortalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
