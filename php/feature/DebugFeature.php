...
// CaliforniaStatePortal SDK debug feature
...
class CaliforniaStatePortalDebugFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _finish(CaliforniaStatePortalContext $ctx, bool $ok): void
    {
