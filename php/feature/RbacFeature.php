...
// CaliforniaStatePortal SDK rbac feature
...
class CaliforniaStatePortalRbacFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _required(CaliforniaStatePortalContext $ctx): ?string
    {
    ...
    private function _reject(CaliforniaStatePortalContext $ctx, string $required): void
    {
    ...
    private function _track(CaliforniaStatePortalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
