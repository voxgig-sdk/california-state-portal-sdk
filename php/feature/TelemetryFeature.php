...
// CaliforniaStatePortal SDK telemetry feature
...
class CaliforniaStatePortalTelemetryFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _close(CaliforniaStatePortalContext $ctx, bool $ok): void
    {
