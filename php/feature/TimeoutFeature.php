...
// CaliforniaStatePortal SDK timeout feature
...
class CaliforniaStatePortalTimeoutFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _with_timeout(CaliforniaStatePortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CaliforniaStatePortalContext $_ctx, float $ms): void
    {
        $client = $this->client;
