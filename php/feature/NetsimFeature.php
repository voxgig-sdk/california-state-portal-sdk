...
// CaliforniaStatePortal SDK netsim feature
...
class CaliforniaStatePortalNetsimFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _simulate(CaliforniaStatePortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CaliforniaStatePortalContext $ctx, array $applied): void
    {
        $client = $this->client;
