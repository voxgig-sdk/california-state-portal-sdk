...
class CaliforniaStatePortalTestRunner
{
    ...
    {
        $live = self::getenv('CALIFORNIASTATEPORTAL_TEST_LIVE');
        $override = self::getenv('CALIFORNIASTATEPORTAL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CALIFORNIASTATEPORTAL_TEST_EXPLAIN');
...
class_alias('CaliforniaStatePortalTestRunner', 'Runner');
class_alias('CaliforniaStatePortalHelpers', 'Helpers');
