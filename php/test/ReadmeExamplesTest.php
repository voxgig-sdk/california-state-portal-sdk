...
// CaliforniaStatePortal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CaliforniaStatePortalSDK::test)
...
{
    private const SDK_CLASS = 'CaliforniaStatePortalSDK';
    ...
    private const SDK_BASE = 'californiastateportal_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../californiastateportal_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
