# CaliforniaStatePortal PHP SDK



The PHP SDK for the CaliforniaStatePortal API — an entity-oriented client using PHP conventions.
...
```php
require_once 'californiastateportal_sdk.php';
$client = new CaliforniaStatePortalSDK($options);
```
...
```
php/
├── californiastateportal_sdk.php          -- Main SDK class
...
The main class (`californiastateportal_sdk.php`) exports the SDK class
