...
describe("ServiceDirect", function()
  it("should direct-list-service", function()
    local setup = service_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-service", setup.live and "live" or "unit")
...
function service_direct_setup(mockres)
