// Command CaliforniaStatePortal-mcp is an MCP server exposing the CaliforniaStatePortal
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CaliforniaStatePortal_list  — list records of an entity
//	CaliforniaStatePortal_load  — load a single record of an entity
//
