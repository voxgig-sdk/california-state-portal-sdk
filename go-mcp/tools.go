...
type Args struct {
	Entity string         `json:"entity" jsonschema:"service"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CaliforniaStatePortalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "california-state-portal_list",
		Description: "List records from CaliforniaStatePortal. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "california-state-portal_load",
		Description: "Load a single record from CaliforniaStatePortal. " +
...
func runOp(client *sdk.CaliforniaStatePortalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CaliforniaStatePortalSDK, name string) (sdk.CaliforniaStatePortalEntity, error) {
