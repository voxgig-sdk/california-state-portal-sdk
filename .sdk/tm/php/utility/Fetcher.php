...
// CaliforniaStatePortal SDK utility: fetcher

class CaliforniaStatePortalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CaliforniaStatePortalSDK/1.0)';
    ...
    public static function call(CaliforniaStatePortalContext $ctx, string $fullurl, array $fetchdef): array
    {
