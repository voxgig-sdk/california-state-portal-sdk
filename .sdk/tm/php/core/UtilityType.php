...
// CaliforniaStatePortal SDK utility type

class CaliforniaStatePortalUtility
{
    ...
    public static function copy(CaliforniaStatePortalUtility $src): CaliforniaStatePortalUtility
    {
        $u = new CaliforniaStatePortalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
