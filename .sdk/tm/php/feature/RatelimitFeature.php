...
// CaliforniaStatePortal SDK ratelimit feature
...
class CaliforniaStatePortalRatelimitFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _acquire(CaliforniaStatePortalContext $ctx): void
    {
    ...
    private function _track(CaliforniaStatePortalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
