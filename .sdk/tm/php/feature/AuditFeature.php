...
// CaliforniaStatePortal SDK audit feature
...
class CaliforniaStatePortalAuditFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _emit(CaliforniaStatePortalContext $ctx, string $outcome): void
    {
