...
// CaliforniaStatePortal SDK streaming feature
...
class CaliforniaStatePortalStreamingFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    private function _iterate(CaliforniaStatePortalResult $result): \Generator
    {
    ...
    private function _streamable(CaliforniaStatePortalContext $ctx): bool
    {
