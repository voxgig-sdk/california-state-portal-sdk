...
// CaliforniaStatePortal SDK clienttrack feature
...
class CaliforniaStatePortalClienttrackFeature extends CaliforniaStatePortalBaseFeature
{
    ...
    public function PostConstruct(CaliforniaStatePortalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CaliforniaStatePortal-SDK';
