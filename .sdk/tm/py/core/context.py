...
class CaliforniaStatePortalContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CaliforniaStatePortalControl()
        ...
        if isinstance(sp, CaliforniaStatePortalSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CaliforniaStatePortalResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CaliforniaStatePortalResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CaliforniaStatePortalOperation({})
    ...
    def make_error(self, code, msg):
        return CaliforniaStatePortalError(code, msg, self)
