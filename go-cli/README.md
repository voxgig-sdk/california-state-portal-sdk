...
AQL-driven CLI and REPL for the CaliforniaStatePortal SDK. Positional arguments are
...
```sh
go build -o california-state-portal-cli ./...
```
...
./california-state-portal-cli load 1 service
./california-state-portal-cli load '{id:1}' service
