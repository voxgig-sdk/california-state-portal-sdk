...
func registerSDKWords(r *eng.Registry, client *sdk.CaliforniaStatePortalSDK) {
...
func runOp(client *sdk.CaliforniaStatePortalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
