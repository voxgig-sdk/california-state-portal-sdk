# CaliforniaStatePortal TypeScript SDK



The TypeScript SDK for the CaliforniaStatePortal API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Service()` — each with a small set of operations (`list`)
...
`list()` resolves to an array of Service objects — iterate it directly:
...
// service is a bare entity populated with mock response data
console.log(service)
```
...
| `tester(testopts?, sdkopts?)` | `CaliforniaStatePortalSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CaliforniaStatePortalSDK.test(testopts?, sdkopts?)` | `CaliforniaStatePortalSDK` | Create a test-mode client. |
...
| `client` | `client(): CaliforniaStatePortalSDK` | Return the parent SDK client. |
...
├── src/
│   ├── CaliforniaStatePortalSDK.ts        # Main SDK class
