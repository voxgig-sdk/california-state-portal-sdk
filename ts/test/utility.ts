...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CALIFORNIASTATEPORTAL_TEST_LIVE ||
    'TRUE' === process.env.CALIFORNIASTATEPORTAL_TEST_OVERRIDE
  ) {
  ...
  m.CALIFORNIASTATEPORTAL_TEST_EXPLAIN = process.env.CALIFORNIASTATEPORTAL_TEST_EXPLAIN || m.CALIFORNIASTATEPORTAL_TEST_EXPLAIN
