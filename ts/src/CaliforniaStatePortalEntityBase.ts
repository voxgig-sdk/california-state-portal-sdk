...
// `class AdviceEntity extends CaliforniaStatePortalEntityBase<Advice>`.
class CaliforniaStatePortalEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: CaliforniaStatePortalSDK
  _utility: Utility
  _entopts: any
